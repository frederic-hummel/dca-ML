function Parameters(
	...
	try
		mkdir("Daten/l=$(l), q=$(q)/Sample $(Sample)")
	end
	writecsv("Daten/l=$(l), q=$(q)/Sample $(Sample)/Parameters h", h0)
	writecsv("Daten/l=$(l), q=$(q)/Sample $(Sample)/Parameters g", g0)
	writecsv("Daten/l=$(l), q=$(q)/Sample $(Sample)/Parameters J", J0)
end